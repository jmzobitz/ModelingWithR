...
```{r log-sde-26,fig.cap="One realization of the logistic differential equation with stochastic variables." }
...
```{r spaghetti-r-26,fig.cap="Several different realizations of the logistic SDE with stochasticity in the variables, along with the ensemble average plot."}
# Many solutions
...
```{r stoch-pred-prey-26,fig.width=4,fig.height=5,fig.cap="One realization of the stochastic predator-prey model."}
# Identify the birth and death parts of the DE:
...
```{r spaghetti-pred-26,fig.cap="Several different realizations of the stochastic predator-prey system."}
...
```{r ensemble-pred-26,fig.cap="Ensemble average plot of the predator-prey system."}
