...
```{tikz, trace-det-18,warning=FALSE,message=FALSE,echo=FALSE,fig.cap="The trace-determinant plane"}
\begin{tikzpicture}
...
```{tikz, trace-det-ref,warning=FALSE,message=FALSE,echo=FALSE,fig.cap="Revised trace-determinant plane."}
