...
Sometimes when working with Euler's method you encounter a differential equation that produces some nonsensible results. For example, consider a model that represents infection with quarantine (see Exercise \@ref(exr:flu-quarantine-01) in @sec-intro-01):
...
a.  Either from a previous assignment or by directly solving here, what is the steady state value?
