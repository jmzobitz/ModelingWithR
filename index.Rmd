...
There is a companion R package available called `demodelr` to run programs and functions in the text.  Instructions to install this package are given in Section \@ref(r-intro-02). The minimum version of R Version 4.0.2 (2020-06-22) and RStudio is Version 1.4.1106.
