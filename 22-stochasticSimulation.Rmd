...
```{r kuopio-weather, echo=FALSE,out.width = "50%",fig.align="center",fig.cap = "Long-term weather forecast for Kuopio, a city in Finland, from the Finnish Weather Institute."}
...
```{r simul-graph,fig.width = 4,fig.height=3,fig.align="center",fig.cap="Timeseries plot of the three simulations from the pivoted data frame."}
my_table_long %>%
...
```{r simul-graph-rev,fig.width = 4,fig.height=3,fig.align="center",fig.cap="Timeseries plot of the three simulations.",message=FALSE,warning=FALSE}
my_table_long %>%
  ggplot(aes(x = t, y = value, group = name)) +
  geom_point() +
  geom_line() +
