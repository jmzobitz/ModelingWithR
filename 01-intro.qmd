...
::: {#exr-herpes-01}
{{< fa burst >}} An important parameter in modeling the spread of diseases is $R_{0}$, which represents if a disease will become an epidemic. If $R_{0}>1$, then the disease will become an epidemic. If $R_{0}<1$, then it will not. For a disease like Herpes, one model is a susceptible - infected ($SI$) model, assuming there is no recovery from Herpes. For this case, an expression for $R_{0}$ is the the following:\
