...
::: {#exr-rumor-07}
{{< fa burst >}} (Inspired by @olinickMathematicalModelingSocial2014) A rumor is spreading through a population of $N$ people, with people who are unaware $U$ of the rumor, and $R$ the people who spread the rumor. A system of differential equations that describes the spread of the rumor through the population is:
