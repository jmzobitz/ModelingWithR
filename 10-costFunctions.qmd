...
e. Let's say researchers believe $\theta \approx \mu \pm \sigma$. What would be a general expression to include in the original cost function $S(1.737,\theta)$ to account for this information? You final expression will have $\mu$ and $\sigma$ in it.
