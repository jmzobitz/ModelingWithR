...
::: {.callout-note}
This chapter uses following libraries: `ggplot2`, and `tibble` (all part of the `tidyverse`). See @sec-packages-02 on how to install packages.  Prior to running any code in this section, include `library(tidyverse)`. 
:::
