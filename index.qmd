...
- Thanks to users (discoleo) and others for pointing out errors and features.

Chapter 22 updated with base R examples
Use of the native pipe |>
Updating of depreciated functions `reframe`
