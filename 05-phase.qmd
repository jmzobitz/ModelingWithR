...
::: {#exr-advert-phase-05}
{{< fa burst >}} The steady state for the differential equation $\displaystyle \frac{dS}{dt} = \frac{rU}{M}(M-S) - \lambda S$ is $\displaystyle S_{*} = \frac{rUM}{rU+\lambda M}$. Apply the local linearization stability test to determine the stability of this equilibrium solution.
:::
